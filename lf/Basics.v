...
Definition grade_comparison (g1 g2 : grade) : comparison :=
  match g1 with
    | (Grade g1_letter g1_modifier) => 
      match g2 with 
        | (Grade g2_letter g2_modifier) =>
          match letter_comparison g1_letter g2_letter with
            | Lt => Lt
            | Eq => modifier_comparison g1_modifier g2_modifier
            | Gt => Gt
          end
      end
  end.
...
(* 
  theorem letter_comparison_Eq : letter_comp l l = Eq
  theorem lower_letter_lowers : letter_comp (lower_letter l) l = Lt
  theorem lower_letter_F_is_F : lower letter F = F
  theorem lower_grade_F_Minus : lower_grade F minus = F minus
*)

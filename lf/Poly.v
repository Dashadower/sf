...
Definition partition {X : Type}
                     ...
                     (l : list X)
                   : list X * list X :=
  (filter test l, filter (fun m => negb (test m)) l).
...
Proof.
  ...
  induction l as [| hl ll IHl].
    - simpl. reflexivity.
    - simpl. rewrite <- IHl.
      rewrite map_distr. simpl. reflexivity.
Qed.
(** [] *)
...
(* X is a list and Y nat, such that the result is the sum of the length of the lists.
